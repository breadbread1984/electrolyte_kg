...
merge (m: Material {smiles: "[Li+].[Cl-]", name: "lithium chloride"}) return m;
match (a: `Material Add` {id: "6ddae682-2303-11ef-8543-8fce4c4a6d0c"}),
...
merge (m: Material {smiles: "S1SSSSSSS1", name: "sulfur"}) return m;
match (a: `Material Add` {id: "426cb268-2304-11ef-8370-7ba134642a67"}),
...
merge (a: `Glove Box Operation` {id: "d2b6c486-292f-11ef-a72b-1ba46a14eb9f", type: "heating", target: "c2", params: "{\"atmosphere\":\"argon\",\"temperature\":\"520\",\"unit\":\"C\",\"warmup seconds\":\"10800\",\"warmup rate\":\"2.5/min\",\"duration seconds\":28800}"});
